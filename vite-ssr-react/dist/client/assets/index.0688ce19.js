...
function createSystem(options = {}) {
  ...
  const themeContent = react.exports.createContext({});
  const SystemProvider = (props) => {
    const [mode, setMode] = react.exports.useState(defaultMode);
    const updataMode = (value) => {
      setMode(value);
      globalMode.mode = value;
    };
    return react.exports.createElement(themeContent.Provider, {
      value: {
        mode,
        setMode: updataMode,
  ...
  const useSystem = () => react.exports.useContext(themeContent);
  let modeIdentifier = [];
  let withIndex = 0;
  const styled2 = (tag, styles, interpolation) => {
    ...
    function createRule(mode, inputTargetInfo) {
      ...
      const variants = typeof interpolation === "function" ? interpolation(theme, mode) : interpolation;
    ...
    const styledComponent = react.exports.forwardRef((props, ref) => {
      const _a2 = props, {
        as = inputTag,
        className = "",
        variants: variantsProps
      } = _a2, rest = __objRest(_a2, ["as", "className", "variants"]);
      ...
      return react.exports.createElement(as, __spreadValues({
  ...
  function createExtracts2() {
    ...
    const extractElement = /* @__PURE__ */ jsxs(Fragment, {
      children: [/* @__PURE__ */ jsx("meta", {
        name: "styils-cache",
        id: metaSelectorCacheId,
        mode: (_d = metaHtml == null ? void 0 : metaHtml.getAttribute("mode")) != null ? _d : globalMode.mode,
...
client.hydrateRoot(document.getElementById("app"), /* @__PURE__ */ jsx(BrowserRouter, {
